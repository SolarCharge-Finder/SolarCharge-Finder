    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title,
          text: 'Check out SolarCharge — find nearby solar charging stations',
          url: shareUrl,
        });
      } catch {
        ...
        <div className="cta-card">
          ...
          <div className="cta-content">
            ...
            <p className="cta-desc">
              Help fellow users by sharing solar charging locations in your area. Every station
              added makes clean energy more accessible for everyone.
            </p>
            <div className="cta-buttons">
              ...
              {open && (
                <div className="cta-share-popover" role="dialog" aria-label="Share options">
                  <button className="cta-share-item" onClick={handleCopy}>
                    Copy link
                  </button>
                  <button className="cta-share-item" onClick={() => openSocial('whatsapp')}>
                    WhatsApp
                  </button>
                  <button className="cta-share-item" onClick={() => openSocial('facebook')}>
                    Facebook
                  </button>
                  <button className="cta-share-item" onClick={() => openSocial('twitter')}>
                    Twitter
                  </button>
                  <button className="cta-share-item" onClick={() => openSocial('linkedin')}>
                    LinkedIn
                  </button>
                </div>
              )}
            ...
            <div className="cta-trust">
              ...
              <span className="trust-text">
                Join <strong>2,500+</strong> contributors sharing clean energy
              </span>
            </div>
          </div>
        </div>
