...
it('shows "Calculating..." when loadingLocation is true', () => {
  ...
  renderWithRouter(<SearchResults stations={stations} error="" loadingLocation={true} />);
...
it('calculates distance when userLocation is provided', () => {
  ...
  renderWithRouter(
    <SearchResults stations={stations} error="" userLocation={{ latitude: 6.9, longitude: 79.8 }} />
  );
