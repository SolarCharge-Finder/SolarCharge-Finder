...
export const addReview = async (req, res, next) => {
  try {
    ...
    station.rating =
      (station.rating * station.totalRatings + normalizedRating) / (station.totalRatings + 1);
...
export const updateReview = async (req, res, next) => {
  try {
    ...
    if (rating !== undefined && station.totalRatings > 0) {
      const updatedTotal = station.rating * station.totalRatings - oldRating + review.rating;
...
export const deleteReview = async (req, res, next) => {
  try {
    ...
    if (station.totalRatings <= 1) {
      ...
      const updatedTotal = station.rating * station.totalRatings - review.rating;
      station.totalRatings -= 1;
      station.rating = updatedTotal / station.totalRatings;
    }
